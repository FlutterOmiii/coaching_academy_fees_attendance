@php
    ...
    $icons = [
        ...
        'bell' => '<path opacity="0.5" d="M18.75 9.71V9.005C18.75 5.136 15.726 2 12 2C8.274 2 5.25 5.136 5.25 9.005V9.71C5.25 10.552 5.008 11.376 4.556 12.077L3.45 13.79C2.439 15.354 3.211 17.481 4.968 17.977C9.578 19.278 14.422 19.278 19.032 17.977C20.789 17.481 21.561 15.354 20.55 13.79L19.444 12.077C18.992 11.376 18.75 10.552 18.75 9.71Z" stroke="currentColor" stroke-width="1.5"/><path d="M7.5 19C8.155 20.748 9.922 22 12 22C14.078 22 15.845 20.748 16.5 19" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>',
